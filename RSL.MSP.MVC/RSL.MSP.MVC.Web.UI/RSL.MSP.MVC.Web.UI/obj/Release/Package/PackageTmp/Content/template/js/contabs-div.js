...
$(function () {
    ...
    function menuItem() {
        ...
        if (flag) {
            ...
            var str1 = '<div class="J_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" frameborder="0" data-id="' + dataUrl + '"></div>';
            $('.J_mainContent').find('div.J_iframe').hide().parents('.J_mainContent').append(str1);
            //显示loading提示
            ...
            $('.J_mainContent').find('div.J_iframe[name="iframe' + dataIndex + '"]').load(dataUrl, function (response, status, xhr) {
                if (status == "error") {
                    $(this).html("錯誤 ");
                }
                //iframe加载完成后隐藏loading提示
    ...
    //关闭全部
    $(".J_tabCloseAll").unbind("click").click(function () {
    ...
    //关闭其他
    $(".J_tabCloseOther").unbind("click").click(function () {
